...
main (int argc, char *argv[])
{
  ...
  burstyHelper.SetBurstGenerator ("ns3::SimpleBurstGenerator",
                                  "PeriodRv", StringValue ("ns3::ConstantRandomVariable[Constant=100e-2]"),
  ...
  AnimationInterface animationInterface("burst-traffic.xml");
//  animationInterface.AnimationInterface::EnablePacketMetadata(true);
//  animationInterface.SetConstantPosition (nodes.Get(0), 1.0, 0.0);
//  animationInterface.SetConstantPosition (nodes.Get(1), 2.0 ,3.0);
