 ...
 * \brief Header with a sequence, a timestamp, a size, a fragment sequence and a number of fragments attribute
 *
 * This header adds a fragment sequence and a number of fragments attribute to the (burst) sequence number,
 * the timestamp and the size of class \c SeqTsSizeFragHeader.
 * Fragment sequence and number of fragments can be used to track large fragments packets over protocols
 * not guaranteeing packet ordering, e.g., BurstyApplication over UDP.
 *
 * \sa ns3::SeqTsHeader
 */
