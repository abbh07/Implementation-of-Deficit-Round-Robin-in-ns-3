...
//   NetDeviceContainer devn0n1 = pointToPoint.Install (n0n1);
  NetDeviceContainer devn0n3 = pointToPoint.Install (n0n3);



  pointToPoint.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
  pointToPoint.SetChannelAttribute ("Delay", StringValue ("2ms"));
  NetDeviceContainer devn1n3 = pointToPoint.Install (n1n3);
...
//   queueDiscs = tch.Install(devn1n2);
  queueDiscs = tch.Install(devn3n4);

  Ipv4AddressHelper ipv4;

  ipv4.SetBase ("10.1.1.0", "255.255.255.0");
//   Ipv4InterfaceContainer i0i1 = ipv4.Assign (devn0n1);
  Ipv4InterfaceContainer i0i3 = ipv4.Assign (devn0n3);

  ipv4.SetBase ("10.1.2.0", "255.255.255.0");
  Ipv4InterfaceContainer i1i3 = ipv4.Assign (devn1n3);
...
//   flowApplication->SetRemote (i1i2.GetAddress (1), port);
  flowApplication1->SetRemote (i3i4.GetAddress (1), port);
...
//   flowApplication->SetRemote (i1i2.GetAddress (1), port);
  ...
  n2n3.Get (0)->AddApplication (flowApplication3);
