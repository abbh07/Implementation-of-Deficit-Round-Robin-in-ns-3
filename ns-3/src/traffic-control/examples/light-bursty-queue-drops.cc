...
//   flowApplication->SetRemote (i1i2.GetAddress (1), port);
  ...
  flowApplication1->SetPacketSize (200);
...
//   n0n1.Get (0)->AddApplication (flowApplication);
  n0n2.Get (0)->AddApplication (flowApplication1);
